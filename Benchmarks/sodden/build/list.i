...
# 11 "../olden/health/src/list.c" 2

void addList(struct List *list, struct Patient *patient) {
  struct List *b;

  while (list != 
# 15 "../olden/health/src/list.c" 3 4
                ((void *)0)
# 15 "../olden/health/src/list.c"
                    ) {
    b = list;
    list = list->forward; }
  ...
  list->forward = 
# 21 "../olden/health/src/list.c" 3 4
                 ((void *)0)
# 21 "../olden/health/src/list.c"
                     ;
  list->back = b;
  b->forward = list;
}
...
void removeList(struct List *list, struct Patient *patient) {
  ...
  l1->forward = l2;
  if (list->forward != 
# 39 "../olden/health/src/list.c" 3 4
                      ((void *)0)
# 39 "../olden/health/src/list.c"
                          ) {
    l1 = list->forward;
    l2 = list->back;
    l1->back = l2;

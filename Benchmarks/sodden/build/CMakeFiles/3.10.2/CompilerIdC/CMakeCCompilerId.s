...
.LVL3:
	.loc 1 578 0
	movq	info_arch(%rip), %rdx
	movsbl	(%rdx,%rdi), %edx
	addl	%eax, %edx
.LVL4:
	.loc 1 580 0
	leaq	info_version(%rip), %rax
	movsbl	(%rax,%rdi), %eax
	addl	%eax, %edx
.LVL5:
	.loc 1 594 0
...
.LC0:
	.string	"INFO:dialect_default[11]"
...
.LASF11:
	.string	"/home/leonardo/Documents/Maestria/Tesis/sodden/build/CMakeFiles/3.10.2/CompilerIdC"
.LASF5:
	.string	"info_arch"
.LASF10:
	.string	"CMakeCCompilerId.c"
.LASF1:

...
# 4 "../olden/voronoi/src/output.c" 2
...
# 5 "../olden/voronoi/src/output.c" 2


# 6 "../olden/voronoi/src/output.c"
...
# 45 "../olden/voronoi/src/output.c"
  ...
  if (
# 50 "../olden/voronoi/src/output.c" 3 4
     __builtin_isnan (
# 50 "../olden/voronoi/src/output.c"
     p1x
# 50 "../olden/voronoi/src/output.c" 3 4
     )
# 50 "../olden/voronoi/src/output.c"
  ...
  if (
# 52 "../olden/voronoi/src/output.c" 3 4
     __builtin_isnan (
# 52 "../olden/voronoi/src/output.c"
     p1y
# 52 "../olden/voronoi/src/output.c" 3 4
     )
# 52 "../olden/voronoi/src/output.c"
  ...
  if (
# 54 "../olden/voronoi/src/output.c" 3 4
     __builtin_isnan (
# 54 "../olden/voronoi/src/output.c"
     p2x
# 54 "../olden/voronoi/src/output.c" 3 4
     )
# 54 "../olden/voronoi/src/output.c"
  ...
  if (
# 56 "../olden/voronoi/src/output.c" 3 4
     __builtin_isnan (
# 56 "../olden/voronoi/src/output.c"
     p2y
# 56 "../olden/voronoi/src/output.c" 3 4
     )
# 56 "../olden/voronoi/src/output.c"
...
void output_voronoi_diagram(QUAD_EDGE edge, int nv, struct EDGE_STACK *my_stack)
{
  ...
  if (voronoi) {
    ...
    do {
      ...
      v21=(((QUAD_EDGE) (((uptrint) (nex)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v->v;
      v22=(nex)->v->v;
      tmp=(nex)->next;
      v23=(((QUAD_EDGE) (((uptrint) (tmp)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v->v;
      ...
      nex = ((QUAD_EDGE) ( (((uptrint) ((((QUAD_EDGE) ( (((uptrint) (nex) + 1*((uptrint) sizeof(struct edge_rec))) & ((uptrint) 4*sizeof(struct edge_rec) - 1)) | ((uptrint) (nex) & ~((uptrint) 4*sizeof(struct edge_rec) - 1)) )))->next) + 3*((uptrint) sizeof(struct edge_rec))) & ((uptrint) 4*sizeof(struct edge_rec) - 1)) | ((uptrint) ((((QUAD_EDGE) ( (((uptrint) (nex) + 1*((uptrint) sizeof(struct edge_rec))) & ((uptrint) 4*sizeof(struct edge_rec) - 1)) | ((uptrint) (nex) & ~((uptrint) 4*sizeof(struct edge_rec) - 1)) )))->next) & ~((uptrint) 4*sizeof(struct edge_rec) - 1)) ));
    } while (nex != edge);
  }
  ...
  while (my_stack->ptr != 0) {
    ...
    if ((edge)->wasseen == 1) {
      ...
      do {
        v1=(prev)->v;
        d1=v1->v.x;
        v2=(((QUAD_EDGE) (((uptrint) (prev)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v;
        d2=v2->v.x;
        if (d1 >= d2 ) {

          plot_dedge(v1,v2);
          sprev = ((QUAD_EDGE) (((uptrint) (prev)) ^ 2*((uptrint) sizeof(struct edge_rec))));
          snex = (sprev)->next;
          v1=(prev)->v;
          v2=(((QUAD_EDGE) (((uptrint) (prev)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v;
          v3=(((QUAD_EDGE) (((uptrint) (nex)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v;
          v4=(((QUAD_EDGE) (((uptrint) (snex)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v;
          if (ccw(v1,v2,v3 )
              != ccw(v1,v2,v4 )) {
            struct VEC2 v21, v22, v23;
            v21 = (prev)->v->v;
            v22 = (((QUAD_EDGE) (((uptrint) (prev)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v->v;
            v23 = (((QUAD_EDGE) (((uptrint) (nex)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v->v;
            vv1 = circle_center(v21,v22,v23
                                                                     );
            v21 = (sprev)->v->v;
            v22 = (((QUAD_EDGE) (((uptrint) (sprev)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v->v;
            v23 = (((QUAD_EDGE) (((uptrint) (snex)) ^ 2*((uptrint) sizeof(struct edge_rec)))))->v->v;
    ...
    push_ring(my_stack, ((QUAD_EDGE) (((uptrint) (edge)) ^ 2*((uptrint) sizeof(struct edge_rec)))));
  }
  zero_seen(my_stack, edge);
}

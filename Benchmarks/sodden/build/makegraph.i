...
# 4 "../olden/mst/src/mst.h" 2
# 1 "../olden/mst/src/hash.h" 1
...
# 4 "../olden/mst/src/hash.h" 2


# 5 "../olden/mst/src/hash.h"
...
Graph MakeGraph(int numvert, int numproc)
{
  ...
  for (i=0; i<1; i++)
    {
      retval->vlist[i]=
# 86 "../olden/mst/src/makegraph.c" 3 4
                      ((void *)0)
# 86 "../olden/mst/src/makegraph.c"
                          ;
    }
  printf("Make phase 2\n");
  for (j=numproc-1; j>=0; j--)
    {
      ...
      v = 
# 92 "../olden/mst/src/makegraph.c" 3 4
         ((void *)0)
# 92 "../olden/mst/src/makegraph.c"
             ;
      for (i=0; i<perproc; i++)
        {

...
Hash MakeHash(int size, int (*map)(unsigned int))
{
  ...
  for (i=0; i<size; i++)
    retval->array[i]=
# 37 "../olden/mst/src/hash.c" 3 4
                    ((void *)0)
# 37 "../olden/mst/src/hash.c"
                        ;
  retval->mapfunc = map;
  retval->size = size;
  return retval;
...
void *HashLookup(unsigned int key, Hash hash)
{
  ...
  return 
# 56 "../olden/mst/src/hash.c" 3 4
        ((void *)0)
# 56 "../olden/mst/src/hash.c"
            ;
}

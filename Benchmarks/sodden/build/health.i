...
# 10 "../olden/health/src/health.c" 2
# 1 "../olden/health/src/health.h" 1
# 23 "../olden/health/src/health.h"
...
# 11 "../olden/health/src/health.c" 2
...
# 12 "../olden/health/src/health.c" 2


# 13 "../olden/health/src/health.c"
int max_level;
long max_time;
long long seed;
...
struct Village *alloc_tree(int level, int label, struct Village *back) {
  if (level == 0)
    return 
# 19 "../olden/health/src/health.c" 3 4
          ((void *)0)
# 19 "../olden/health/src/health.c"
              ;
  else {
    struct Village *new;
    int i;
    ...
    new->hosp.assess.forward = 
# 36 "../olden/health/src/health.c" 3 4
                              ((void *)0)
# 36 "../olden/health/src/health.c"
                                  ;
    new->hosp.assess.back = 
# 37 "../olden/health/src/health.c" 3 4
                           ((void *)0)
# 37 "../olden/health/src/health.c"
                               ;
    new->hosp.assess.patient = 
# 38 "../olden/health/src/health.c" 3 4
                              ((void *)0)
# 38 "../olden/health/src/health.c"
                                  ;
    new->hosp.waiting.forward = 
# 39 "../olden/health/src/health.c" 3 4
                               ((void *)0)
# 39 "../olden/health/src/health.c"
                                   ;
    new->hosp.waiting.back = 
# 40 "../olden/health/src/health.c" 3 4
                            ((void *)0)
# 40 "../olden/health/src/health.c"
                                ;
    new->hosp.waiting.patient = 
# 41 "../olden/health/src/health.c" 3 4
                               ((void *)0)
# 41 "../olden/health/src/health.c"
                                   ;
    new->hosp.inside.forward = 
# 42 "../olden/health/src/health.c" 3 4
                              ((void *)0)
# 42 "../olden/health/src/health.c"
                                  ;
    new->hosp.inside.back = 
# 43 "../olden/health/src/health.c" 3 4
                           ((void *)0)
# 43 "../olden/health/src/health.c"
                               ;
    new->hosp.inside.patient = 
# 44 "../olden/health/src/health.c" 3 4
                              ((void *)0)
# 44 "../olden/health/src/health.c"
                                  ;
    new->hosp.up.forward = 
# 45 "../olden/health/src/health.c" 3 4
                          ((void *)0)
# 45 "../olden/health/src/health.c"
                              ;
    new->hosp.up.back = 
# 46 "../olden/health/src/health.c" 3 4
                       ((void *)0)
# 46 "../olden/health/src/health.c"
                           ;
    new->hosp.up.patient = 
# 47 "../olden/health/src/health.c" 3 4
                          ((void *)0)
# 47 "../olden/health/src/health.c"
                              ;
    new->returned.back = 
# 48 "../olden/health/src/health.c" 3 4
                        ((void *)0)
# 48 "../olden/health/src/health.c"
                            ;
    new->returned.forward = 
# 49 "../olden/health/src/health.c" 3 4
                           ((void *)0)
# 49 "../olden/health/src/health.c"
                               ;
...
struct Results get_results(struct Village *village) {
  ...
  if (village == 
# 70 "../olden/health/src/health.c" 3 4
                ((void *)0)
# 70 "../olden/health/src/health.c"
                    ) return r1;
  ...
  while (list != 
# 86 "../olden/health/src/health.c" 3 4
                ((void *)0)
# 86 "../olden/health/src/health.c"
                    ) {
    p = list->patient;
...
void check_patients_inside(struct Village *village, struct List *list)
{
  ...
  while (list != 
# 103 "../olden/health/src/health.c" 3 4
                ((void *)0)
# 103 "../olden/health/src/health.c"
                    ) {
    p = list->patient;
    t = p->time_left;
    p->time_left = t - 1;
...
struct List *check_patients_assess(struct Village *village, struct List *list) {
  ...
  struct Patient *p;
  struct List *up = 
# 121 "../olden/health/src/health.c" 3 4
                   ((void *)0)
# 121 "../olden/health/src/health.c"
                       ;
  long long s;
  int label, t;

  while (list != 
# 125 "../olden/health/src/health.c" 3 4
                ((void *)0)
# 125 "../olden/health/src/health.c"
                    ) {
    p = list->patient;
    t = p->time_left;
    p->time_left = t - 1;
...
void check_patients_waiting(struct Village *village, struct List *list) {
  ...
  while (list != 
# 160 "../olden/health/src/health.c" 3 4
                ((void *)0)
# 160 "../olden/health/src/health.c"
                    ) {
...
struct Patient *generate_patient(struct Village *village)
{
  ...
  return 
# 215 "../olden/health/src/health.c" 3 4
        ((void *)0)
# 215 "../olden/health/src/health.c"
            ;
}
...
struct List *sim(struct Village *village)
{
  ...
  int label;
  if (village == 
# 263 "../olden/health/src/health.c" 3 4
                ((void *)0)
# 263 "../olden/health/src/health.c"
                    ) return 
# 263 "../olden/health/src/health.c" 3 4
                             ((void *)0)
# 263 "../olden/health/src/health.c"
  ...
  for (i = 3; i >= 0; i--) {
    ...
    if (l != 
# 278 "../olden/health/src/health.c" 3 4
            ((void *)0)
# 278 "../olden/health/src/health.c"
                ) {
      l = l->forward;
      while (l != 
# 280 "../olden/health/src/health.c" 3 4
                 ((void *)0)
# 280 "../olden/health/src/health.c"
                     ) {
 ...
 removeList(valI, l->patient);
  ...
  if ((patient = generate_patient(village)) != 
# 293 "../olden/health/src/health.c" 3 4
                                              ((void *)0)
# 293 "../olden/health/src/health.c"
                                                  ) {
    label = village->label;

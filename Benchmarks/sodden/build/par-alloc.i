# 1 "../olden/treeadd/src/par-alloc.c"
...
# 1 "<command-line>" 2
# 1 "../olden/treeadd/src/par-alloc.c"
# 11 "../olden/treeadd/src/par-alloc.c"
# 1 "../olden/treeadd/src/tree.h" 1
...
# 8 "../olden/treeadd/src/tree.h" 2





# 12 "../olden/treeadd/src/tree.h"
typedef struct tree {
    int val;
...
# 12 "../olden/treeadd/src/par-alloc.c" 2
extern void *malloc(unsigned);

tree_t *TreeAlloc (int level, int lo, int proc) {
  if (level == 0)
    return 
# 16 "../olden/treeadd/src/par-alloc.c" 3 4
          ((void *)0)
# 16 "../olden/treeadd/src/par-alloc.c"
              ;
  else {

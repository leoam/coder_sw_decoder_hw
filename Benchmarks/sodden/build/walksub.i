...
# 1 "../olden/bh/src/defs.h" 1
# 10 "../olden/bh/src/defs.h"
...
# 11 "../olden/bh/src/defs.h" 2
# 20 "../olden/bh/src/defs.h"
...
# 1 "../olden/bh/src/stdinc.h" 1
# 21 "../olden/bh/src/stdinc.h"
...
# 28 "../olden/bh/src/stdinc.h"
typedef FILE *stream;
# 42 "../olden/bh/src/stdinc.h"
typedef short int bool;
# 52 "../olden/bh/src/stdinc.h"
...
# 86 "../olden/bh/src/stdinc.h"
typedef void (*proc)();
typedef int (*iproc)();
typedef real (*rproc)();
# 25 "../olden/bh/src/defs.h" 2


# 1 "../olden/bh/src/vectmath.h" 1
# 25 "../olden/bh/src/vectmath.h"
typedef real vector[3], matrix[3][3];

extern double sqrt(double x);
# 28 "../olden/bh/src/defs.h" 2


extern double fabs();
# 58 "../olden/bh/src/defs.h"
typedef struct node{
    short type;
    real mass;
    vector pos;
...
hgstruct walksub(nodeptr p, real dsq, real tolsq, hgstruct hg, int level)
{
  ...
  if (subdivp(p, dsq, tolsq, hg)) {
    for (k = 0; k < (1 << 3); k++) {
      r = (((cellptr) p)->subp)[k];
      if (r != 
# 30 "../olden/bh/src/walksub.c" 3 4
              ((void *)0)
# 30 "../olden/bh/src/walksub.c"
                  )

#line 582 "../c/../book/sym.nw"
/* C compiler: symbol table management */
#include "c.h"

#line 86 "../c/../book/sym.nw"
...
#line 195 "../c/../book/sym.nw"
void enterscope() {
	if (++level >= USHRT_MAX)
		error("compound statements nested too deeply\n");
}
#line 202 "../c/../book/sym.nw"
void exitscope() {
	rmtypes();
	rmtemps(0, level);
	if (identifiers->level == level) {
		
#line 228 "../c/../book/sym.nw"
if (Aflag >= 2) {
	int n = 0;
	Symbol p;

#line 85 "../c/../book/storage.nw"
/* C compiler: tree management */

#line 109 "../c/../book/storage.nw"
#include "c.h"

#line 18 "../c/../book/storage.nw"
...
/* added by mcc 1/13/95 for incr in expr.c */
Tree copytree(t) Tree t; {
   register Tree p;
   ...
   if (ntree < sizeof trees/sizeof trees[0])
      ...
      p = (Tree)talloc(sizeof *p);
   *p = *t;
   p->kids[0] = copytree(t->kids[0]);
   p->kids[1] = copytree(t->kids[1]);
   return p;
}

#line 490 "../c/../book/expr.nw"
/* retype - return a copy of tree p with type field = ty */
#line 340 "../c/../book/expr.nw"
